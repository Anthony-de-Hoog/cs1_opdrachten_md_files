namespace IfOpdracht4
{
    internal class EnemyCollider
    {
        internal bool CanPassWall(Enemy enemy)
        {
            ...
            return (enemy.flying|| enemy.incoporial || enemy.subterranian == true);//vervang false, een enemy mag door een muur als 1 van  (flying,incoporial,subterranian) true is;
        }
